...
let count3 = 0;
const guessingWords = [
  "abet", "abut", "ache", "ante", "arch", "aver", "avow", "back", "bade", "bail",
  "bait", "bake", "bale", "balk", "ball", "band", "bang", "bank", "barb", "bard",
  "bare", "barf", "bark", "base", "bash", "bask", "bate", "bawl", "bead", "beam",
  "bean", "bear", "beat", "beef", "been", "beep", "bell", "belt", "bend", "bent",
  "bias", "bide", "biff", "bike", "bilk", "bill", "bind", "bird", "bite", "blab",
  "blat", "bled", "blew", "blob", "blot", "blow", "blub", "blue", "blur", "boat",
  "bode", "body", "boil", "bolt", "bomb", "bond", "bone", "bong", "bonk", "book",
  "boom", "boot", "bore", "born", "boss", "bowl", "brag", "bray", "bred", "brew",
  "brim", "buck", "buff", "bulk", "bull", "bump", "bung", "bunk", "bunt", "buoy",
  "burl", "burn", "burp", "burr", "bury", "bush", "busk", "buss", "bust", "busy",
  "butt", "buzz", "cage", "cake", "calk", "call", "calm", "came", "camp", "cane",
  "cant", "card", "care", "cart", "case", "cash", "cast", "cave", "cede", "cere",
  "chap", "char", "chat", "chin", "chip", "chop", "chug", "chum", "cite", "clad",
  "clam", "clap", "claw", "clip", "clog", "clot", "cloy", "club", "clue", "coal",
  "coat", "coax", "code", "coil", "coin", "coke", "comb", "come", "cone", "conk",
  "cook", "cool", "coop", "cope", "copy", "cord", "core", "cork", "corn", "cost",
  "crab", "cram", "crew", "crib", "crop", "crow", "cube", "cuff", "cull", "curb",
  "cure", "curl", "dado", "damn", "damp", "dang", "dare", "darn", "dart", "dash",
  "date", "daub", "dawn", "daze", "deal", "deck", "deed", "deem", "defy", "dent",
  "deny", "dial", "dice", "died", "diet", "dine", "ding", "disc", "dish", "disk",
  "dive", "dock", "doff", "dole", "done", "doom", "dope", "dote", "dove", "down",
  "doze", "drag", "draw", "drew", "drip", "drop", "drug", "drum", "duck", "duel",
  "dull", "dump", "dung", "dunk", "dupe", "dusk", "dust", "earn", "ease", "echo",
  "edge", "edit", "emit", "envy", "etch", "even", "exit", "face", "fade", "fail",
  "fake", "fall", "fare", "farm", "fast", "fate", "fawn", "faze", "fear", "feed",
  "feel", "fell", "felt", "fend", "fete", "feud", "file", "fill", "film", "find",
  "fine", "fink", "fire", "firm", "fish", "fist", "fizz", "flag", "flap", "flat",
  "flaw", "flay", "fled", "flee", "flew", "flex", "flip", "flit", "flog", "flop",
  "flow", "flub", "flux", "foal", "foam", "foil", "fold", "fond", "fool", "foot",
  "ford", "fork", "form", "foul", "fowl", "fray", "free", "fret", "fuel", "full",
  "fume", "fund", "funk", "furl", "fuse", "fuss", "gain", "gait", "gall", "game",
  "gang", "gape", "garb", "gash", "gasp", "gate", "gave", "gawk", "gaze", "gear",
  "geld", "gift", "gild", "gimp", "gird", "give", "glom", "glow", "glue", "glut",
  "gnaw", "goad", "golf", "gone", "gong", "goof", "gore", "gown", "grab", "gray",
  "grew", "grey", "grid", "grin", "grip", "grit", "grow", "grub", "gull", "gulp",
  "gush", "gust", "hack", "hail", "hale", "halt", "hand", "hang", "hare", "hark",
  "harm", "harp", "hash", "hate", "haul", "have", "hawk", "haze", "head", "heal",
  "heap", "hear", "heat", "heed", "heel", "heft", "held", "helm", "help", "herd",
  "hide", "hike", "hill", "hint", "hire", "hiss", "hive", "hoax", "hock", "hold",
  "hole", "home", "hone", "honk", "hood", "hoof", "hook", "hoop", "hoot", "hope",
  "horn", "hose", "host", "howl", "huff", "hulk", "hull", "hump", "hung", "hunt",
  "hurl", "hurt", "hush", "husk", "hymn", "hype", "idle", "inch", "iron", "itch",
  "jack", "jade", "jail", "jazz", "jeer", "jell", "jerk", "jest", "jibe", "jilt",
  "jinx", "jive", "join", "joke", "jolt", "josh", "jump", "junk", "keel", "keen",
  "keep", "kept", "kick", "kill", "kink", "kiss", "kite", "knew", "knit", "knot",
  "know", "lace", "lack", "laid", "lain", "lamb", "lame", "land", "lard", "lark",
  "lash", "last", "lead", "leaf", "leak", "lean", "leap", "leer", "left", "lend",
  "lent", "lick", "lift", "like", "lilt", "lime", "limp", "line", "link", "lisp",
  "list", "live", "load", "loaf", "loan", "lock", "loft", "long", "look", "loom",
  "loop", "loot", "lope", "lord", "lose", "lost", "love", "luck", "lull", "lump",
  "lure", "lurk", "lust", "made", "mail", "maim", "make", "mark", "mask", "mate",
  "maul", "meet", "meld", "melt", "mend", "meow", "mess", "milk", "mime", "mind",
  "mine", "miss", "moan", "mock", "moor", "moot", "mope", "move", "muck", "muff",
  "muse", "mush", "must", "mute", "nail", "name", "near", "neck", "need", "nest",
  "nick", "nose", "note", "nuke", "numb", "obey", "ogle", "okay", "omen", "omit",
  "ooze", "open", "oust", "pace", "pack", "page", "pain", "pair", "palm", "pant",
  "pare", "park", "part", "pass", "pave", "pawn", "peak", "peal", "peck", "peek",
  "peel", "peep", "peer", "perk", "pick", "pile", "pine", "plan", "play", "plod",
  "plop", "plot", "plow", "plug", "poke", "pool", "pore", "pose", "post", "pour",
  "pout", "pray", "prim", "prod", "prop", "puff", "pull", "pulp", "pump", "purr",
  "push", "putt", "quip", "quit", "quiz", "race", "rage", "raid", "rain", "rake",
  "rang", "rank", "rant", "rate", "raze", "read", "ream", "reap", "reef", "reek",
  "reel", "rein", "rely", "rend", "rent", "rest", "rice", "ride", "rile", "ring",
  "riot", "rise", "risk", "roam", "roar", "rock", "rode", "roil", "roll", "romp",
  "roof", "room", "root", "rope", "rout", "rove", "ruin", "rule", "rush", "rust",
  "sack", "said", "sail", "sale", "salt", "sass", "sate", "save", "sawn", "scab",
  "scam", "scan", "scar", "seat", "seed", "seek", "seem", "seen", "seep", "sell",
  "send", "sent", "sewn", "sham", "shed", "ship", "shoe", "shoo", "shop", "shot",
  "show", "shun", "shut", "side", "sift", "sigh", "sign", "sing", "sink", "sire",
  "site", "size", "skew", "skid", "skim", "skin", "skip", "slab", "slag", "slam",
  "slap", "slat", "slay", "sled", "slew", "slid", "slim", "slip", "slit", "slog",
  "slop", "slot", "slow", "slug", "slum", "slur", "snag", "snap", "snip", "snow",
  "snub", "soak", "soap", "soar", "sock", "soil", "sold", "sole", "solo", "sort",
  "sour", "sown", "spam", "span", "spar", "spat", "sped", "spew", "spin", "spit",
  "spot", "spud", "spur", "stab", "stag", "star", "stay", "stem", "step", "stew",
  "stir", "stop", "stow", "stub", "stud", "stun", "suck", "suit", "sulk", "sung",
  "sunk", "surf", "swab", "swam", "swap", "swat", "sway", "swig", "swim", "swum",
  "tack", "tail", "talk", "tame", "tamp", "tank", "tape", "task", "taxi", "team",
  "tear", "teem", "tell", "tend", "tent", "term", "test", "text", "thaw", "thin",
  "thud", "tick", "tide", "tile", "tilt", "time", "ting", "tint", "tire", "toil",
  "told", "toll", "tone", "took", "tool", "toot", "tore", "torn", "toss", "tote",
  "tour", "tout", "tram", "trap", "tree", "trek", "trim", "trip", "trod", "trot",
  "true", "tube", "tuck", "tune", "turf", "turn", "tusk", "twin", "twit", "type",
  "undo", "urge", "vamp", "vary", "veer", "veil", "vein", "vend", "vent", "vest",
  "veto", "view", "visa", "vise", "void", "vote", "wade", "waft", "wage", "wail",
  "wait", "wake", "walk", "wall", "wane", "want", "ward", "warm", "warn", "warp",
  "wash", "wave", "wean", "wear", "weed", "weep", "weld", "well", "welt", "wend",
  "went", "wept", "were", "wham", "whet", "whip", "whir", "whiz", "will", "wilt",
  "wine", "wink", "wipe", "wire", "wish", "woke", "wolf", "wood", "woof", "word",
  "wore", "work", "worm", "worn", "wove", "wrap", "yank", "yard", "yarn", "yawn",
  "yell", "yelp", "yoke", "zero", "zest", "zing", "zone", "zoom",
];
...
newGameBtn.addEventListener("click", () => {
  ...
  for (let i = 0; i < squaresOfRowOne.length; i++) {
    ...
    // squaresOfRowOne[i].style = "border: 2px solid #a8a7a7";
  }
  for (let i = 0; i < squaresOfRowTwo.length; i++) {
    squaresOfRowTwo[i].innerHTML = "";
    squaresOfRowTwo[i].style.backgroundColor = "#3e3d3d";
    squaresOfRowTwo[i].style = "transform: rotateY(360deg)";
    squaresOfRowTwo[i].style = "transition: 1.5s";
  ...
  for (let i = 0; i < squaresOfRowThree.length; i++) {
    ...
    squaresOfRowThree[i].style = "transform: rotateY(360deg)";
    squaresOfRowThree[i].style = "transition: 1.5s";
  ...
  for (let i = 0; i < squaresOfRowFour.length; i++) {
    ...
    squaresOfRowFour[i].style = "transform: rotateY(360deg)";
    squaresOfRowFour[i].style = "transition: 1.5s";
  ...
  for (let i = 0; i < squaresOfRowFive.length; i++) {
    ...
    squaresOfRowFive[i].style = "transform: rotateY(360deg)";
    squaresOfRowFive[i].style = "transition: 1.5s";
